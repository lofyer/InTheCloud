...
在部署以及使用的时候，有些概念你会经常碰到，在此我先提前列举出来。
...
#. 当一个卷正在使用时，你删除了其中一个brick，并试图再次使用时，可能会出现“/bricks/app or a prefix of it is already part of a volume”，对于3.3版本以后的glusterfs有此问题。
